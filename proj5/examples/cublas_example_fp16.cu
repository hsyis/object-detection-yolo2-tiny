...
int main(int argc, char *argv[]) {
  ...
  cudaStat = cudaMalloc((void **)&d_a_half, m * k * sizeof(half1));
  cudaStat = cudaMalloc((void **)&d_b_half, k * n * sizeof(half1));
  cudaStat = cudaMalloc((void **)&d_c_half, m * n * sizeof(half1));
